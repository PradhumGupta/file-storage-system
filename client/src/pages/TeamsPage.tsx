...
export default function TeamsPage() {
  ...
  return (
    <div className="flex bg-gray-100 p-4 font-sans">
      ...
      <div className="flex flex-1 bg-white rounded-[40px] font-sans shadow-lg overflow-hidden max-sm:overflow-x-auto">
        {/* Sidebar */}
          ...
          <header className="flex items-center justify-between m-4">
            <div>
              <h2 className="text-2xl font-semibold text-gray-900">
                {selectedTeamData ? selectedTeamData.name : "Teams"}
              </h2>
              {selectedTeamData && (
